...
def save_logs(train_log, valid_log):
    np.save("unetplus-32-epoch-40-focal/train_log.npy", train_log)
    np.save("unetplus-32-epoch-40-focal/valid_log.npy", valid_log)
...
for i in range(0, EPOCHS):
    ...
    if (min_score > valid_mean):
        ...
        torch.save(model.state_dict(), 'unetplus-32-epoch-40-focal/best_model_dict.pth')
        print("Model saved!")
    if i == EPOCHS / 2:
