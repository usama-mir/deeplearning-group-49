...
def save_logs(train_log, valid_log):
    np.save("../unet-64-epoch-40-dice/train_log.npy", train_log)
    np.save("../unet-64-epoch-40-dice/valid_log.npy", valid_log)
...
for i in range(0, EPOCHS):
    ...
    if (min_score > valid_mean):
        ...
        torch.save(model.state_dict(), 'unet-64-epoch-40-dice/best_model_dict.pth')
        print("Model saved!")
    if i == EPOCHS / 2:
